...
// }
//
// pub struct MiniRHSSequenceBuilder {
...
// }
//
// impl Component for MiniRHSSequenceBuilder {
//     type Message = Msg;
...
//                                 <div class="uk-margin">
//                                     <h4>{"Sequence Type"}</h4>
//                                     <SequenceTypeDropdown eject=self.link.callback(Msg::UpdateSequenceType) selected=referrer_handling_selected.unwrap() />
//                                 </div>
//
//                                 <div class="uk-margin">
