...
macro_rules! languages_table {
    (
        ...
        #[derive(Debug, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize, EnumIter)]
        pub enum $enum_name {
            $(
                #[doc=$name]
                #[serde(rename=$code)]
        ...
        impl $enum_name {
            ...
            ///
            /// ```
            /// use ad_buy_engine::LanguageCode;
            ///
...
//         $(($variant:ident, $code:literal, $code_t:literal, $code_b:literal, $name:literal, $family:literal),)+
//     ) => {
//         #[derive(Debug, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, EnumString, ToString, EnumIter, Serialize, Deserialize)]
//         pub enum $enum_name {
//             $(
//                 #[serde(rename=$code)]
